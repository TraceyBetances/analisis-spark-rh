...
class RRHH_requests(n_arg: String, spark_arg: SparkSession) {

  val nombre: String = n_arg
  ...
  def DF_query2(): Unit = {
    ...
    val W_query2 = DF_query2.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/empleados_y_departamentos_SA_"+nombre)
  }
  ...
  def DF_query3(): Unit = {
    ...
    /**
      ...
      * su descarga y posterior envío.
      */
    val W_query3 = DF_query3.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/empleados_Toronto_SA_"+nombre)
  }
  ...
  def DF_query4(): Unit = {
    ...
    val W_query4 = DF_query4.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/empleado_manager_SA_"+nombre)
  }
  ...
  def DF_query5(): Unit = {
    ...
    val W_query5 = DF_query5.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/empleado_manager_CEO_SA_"+nombre)
  }
  ...
  def DF_query6(): Unit = {
    ...
    val W_query6 = DF_query6.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/empleado_y_compañeros_SA_"+nombre)
  }
  ...
  def DF_query7(): Unit = {
    ...
    /**
      ...
      * su descarga y posterior envío.
      */
    val W_query7 = DF_query7.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/empleados_despues_Davies_SA_" +nombre)
  }
  ...
  def DF_query8(): Unit = {
    ...
    val W_query8 = DF_query8.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/empleados_antes_manager_SA_"+nombre)
  }
}
