...
object master_querys {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val control_querys = new RRHH_requests(args(0), spark)

    val flagControl_DF_query1 = true
    val flagControl_DF_query2 = true
    val flagControl_DF_query3 = true
    ...
    if (flagControl_DF_query1) {
      //Control sae_dwc
      control_querys.DF_query1()
    }

    if (flagControl_DF_query2) {
      //Control sae_dwc
      control_querys.DF_query2()
    }

    if (flagControl_DF_query3) {
      //Control sae_dwc
      control_querys.DF_query3()
    }

    if (flagControl_DF_query4) {
      //Control sae_dwc
      control_querys.DF_query4()
    }

    if (flagControl_DF_query5) {
      //Control sae_dwc
      control_querys.DF_query5()
    }

    if (flagControl_DF_query6) {
      //Control sae_dwc
      control_querys.DF_query6()
    }
