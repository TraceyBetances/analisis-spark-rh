...
object peticiones_RH {
  def main(args: Array[String]): Unit = {
    ...
    /**
      ...
      */
    val W_query1 = DF_query1.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/domicilios_dep_SA.csv")
...
/**
  ...
  */
    ...
    val W_query2 = DF_query2.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/empleados_y_departamentos_SA.csv")
...
/**
  ...
  * su descarga y posterior envío.
  */
val W_query3 = DF_query3.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/empleados_Toronto_SA.csv")
    /**
    ...
    val W_query4 = DF_query4.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/empleado_manager_SA.csv")
    ...
    val W_query5 = DF_query5.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/empleado_manager_CEO_SA.csv")
    ...
    val W_query6 = DF_query6.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/empleado_y_compañeros_SA.csv")
    ...
    /**
      ...
      * su descarga y posterior envío.
      */
    val W_query7 = DF_query7.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/empleados_despues_Davies_SA.csv")
    ...
    val W_query8 = DF_query8.repartition(1).write.option("header","true").csv("/rrhh/peticiones_departamento_RRHH/empleados_antes_manager_SA.csv")
